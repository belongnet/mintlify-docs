...
```
To create a product collection, follow the following instructions  
---
title: "To create a product collection, follow the following instructions "
url: "https://belongnet.mintlify.app/app/collection/product"
---
